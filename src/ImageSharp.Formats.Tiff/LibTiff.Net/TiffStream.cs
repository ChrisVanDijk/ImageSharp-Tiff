...
namespace BitMiracle.LibTiff.Classic
{
    ...
    class TiffStream
    {
        ...
        public virtual int Read(Stream stream, byte[] buffer, int offset, int count)
        {
        ...
        public virtual void Write(Stream stream, byte[] buffer, int offset, int count)
        {
            //Stream stream = clientData as Stream;
            //if (stream == null)
        ...
        public virtual long Seek(Stream stream, long offset, SeekOrigin origin)
        {
        ...
        public virtual long Size(Stream stream)
        {
            //Stream stream = clientData as Stream;
            //if (stream == null)
