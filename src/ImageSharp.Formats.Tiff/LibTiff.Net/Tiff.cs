...
namespace BitMiracle.LibTiff.Classic
{
    ...
    partial class Tiff : IDisposable
    {
        ...
        /// </remarks>
        public static Tiff Open(Stream stream, string mode)
        {
            return Tiff.Open(stream, mode, null, null);
        }
        ...
        /// </para>
        /// </remarks>
        public static Tiff ClientOpen(string name, string mode, Stream clientData, TiffStream stream)
        {
        ...
        public object SetClientdata(Stream data)
        {
